...
normalizer = AmplitudeNormalizer(max_rows=6, buffer_size=3, alpha=0.5, window_size=5, poly_order=2)
...
try:
    while True:
        ...
        current_normalized = normalizer.normalize_amplitudes(amplitudes, audio_data)
